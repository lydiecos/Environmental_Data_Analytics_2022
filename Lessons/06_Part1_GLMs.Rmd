...
# depth and irradiance are significantly related
...
par(mfrow = c(1,1))
# Normal QQ: should be a straight line
# Scale-Location: Want red line fairly straight and an even distribution
```
...
irradiancebydepth3 <- 
  ggplot(PeterPaul.chem.nutrients, aes(x = depth, y = irradianceWater)) +
  geom_point(color="darkcyan", alpha=.5) +
  scale_y_log10() +  #log transformed values for irradianceWater
  geom_smooth(method = 'lm', se = FALSE, color = "navy") +
  labs(x="Depth", y="Irradiance")  
