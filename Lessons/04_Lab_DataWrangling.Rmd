...
NTL.phys.data.TuesdayL <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 %in% c(1990:1999))

```
Question: Why don't we filter using row numbers?

> Answer: Row numbers are arbitrary.
...
NTL.phys.data.TuesJuly <- NTL.phys.data %>% 
