...
```{r ex1.pull.and.plot.discharge.data}
#Set the URL
...
```{r}
#Apply the API key
census_api_key("b00323039d9108f38200d81f887808e0594ab5ce", install = TRUE)
...
the_df <- data_frame("State" = the_states, 
...
df_2017 <- scrape.it(2017)  # watch video for fixed function
